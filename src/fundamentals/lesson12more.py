...
class Animal:
    ...
    def make_sound(self):
        return f'RUMBLE goes the {self._family}'
...
class Frog(Animal):
    ...
    def info(self):
        return f'My frog\'s name is {self._name} and he is an {self._family}'
...
class Dog(Animal):
    ...
    def info(self):
        return f'My dog\'s name is {self._name} and he is a {self._family}'
