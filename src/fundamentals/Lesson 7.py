...
def basic_for():
    ...
    The in keyword indicates the individual character of
...
def basic_range():
    ...
    and prints the values of the range. The Stop Argument
    """
...
def other_range():
        ...
        arguments. It can accept negative values. The start
        value has to be smaller than the stop. Otherwise you
        get an empty result.
        """
...
def nested_for():
    """ THis nested for loop defines and outer and inner
    for loop. For every outer loop, the inner loop will iterate
    through its whole sequence.
    """
