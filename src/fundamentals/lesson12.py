...
objects that will extent this parent object. They
...
class Cat:
    ...
    def move(self):
        print(f'{self._name} cat can move fast.')
...
class Cheetah(Cat):
    ...
    def sound(self):
        print(f'{self._name} cheetah  {self._behavior}.')
...
def parent_example():
    ...
    me.my_last()
    # child2 object
    my_son = Child2('Matt', 'ODell', 'Brian')
    # child2 calls method
    my_son.my_real_name()
    # child2 calls parent
    my_son.my_name()
