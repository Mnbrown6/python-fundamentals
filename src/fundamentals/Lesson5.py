...
def basic_math(value1: int, value2: int):
    """Basic math values calculate from left to
...
def math_order():
    ...
    pem1 = 10 / (3 + 2) * 4 + 5 ** 2 + 6 - 9
    pem2 = 10 / 3 + 2 * 4 + 5 ** 2 + 6 - 9
...
def compare_op(value1,value2):
    """Comparison operators compare two values with
